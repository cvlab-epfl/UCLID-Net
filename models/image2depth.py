...
## Credits @haofengac
# See https://github.com/haofengac/MonoDepth-FPN-PyTorch
...
class image2depth(nn.Module):
  def __init__(self):
    super(image2depth, self).__init__()
    models.resnet.CONV3X3_BIAS = True
    resnet = models.resnet.resnet18conv()
    ...
    # Top layer
    self.toplayer = nn.Conv2d(512, 128, kernel_size=1, stride=1, padding=0)  # Reduce channels
    ...
    # Aggregate layers
    self.agg1 = agg_node(128, 128)
    self.agg2 = agg_node(128, 128)
    self.agg3 = agg_node(128, 128)
    self.agg4 = agg_node(128, 128)
